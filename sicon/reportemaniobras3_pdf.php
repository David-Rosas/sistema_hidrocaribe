<?php
		...
		{
			$sql = "SELECT id,fecha,valvula,catvalvula,hora,nvueltas,tvuelta1,horar2,nvueltas2,tvuelta2,horar3,nvueltas3,tvuelta3,horar4,nvueltas4,tvuelta4,horar5,nvueltas5,tvuelta5 FROM maniobras WHERE valvula = '$id' and eliminado=0";	
		}
	  ...
	  $titulo = array(array("Fecha","Valvula","Categoria","Hora","N.Vtas","","Hora","N.Vtas","","Hora","N.Vtas","","Hora","N.Vtas","","Hora","N.Vtas",""));
