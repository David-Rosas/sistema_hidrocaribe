...
<br>
<input type="submit" value="Guardar" onClick="this.form.action='areportepclavellino.php'">
<input type="submit" value="Modificar" onClick="this.form.action='mreportepclavellino.php'">
<input type="submit" value="Buscar" onClick="this.form.action='breportepclavellino.php'">
</form>
