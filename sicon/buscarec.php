...
$cuerpo->abrir_head();
	...
	$marco->abrir_marco();
		...
		$tabla = new grid($connection,"id,fecha,hora,sitio,causa,causa2,observacion,fechaa,horaa,atendido","estaciones",array("Codigo","Fecha","Hora","Planta","Causa","Categoria","Observación","Fecha A","Hora Arranque","Atendido"),array($editar,$imprimir1),"(causa='".$causa."')","causa desc limit 20");
