...
$cuerpo->set_titulo("SICOCON - BUSQUEDA DE ORDENES DE TRABAJO FINALIZADAS CON LISTADO DE SUSPENSIONES");
$cuerpo->set_languaje();
...
$cuerpo->abrir_head();
	...
	$cuerpo->add_script($dir_javascript."orden_suspension_buscar_f.js");
$cuerpo->cerrar_head();
