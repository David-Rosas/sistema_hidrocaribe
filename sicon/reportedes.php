...
$cuerpo->set_titulo("SICON -REPORTE DE ESTACIONES DE AGUA SERVIDAS");
$cuerpo->set_languaje();
...
$cuerpo->abrir_body('align="center"',' action="estacioness_buscar.php" method="post" name="form"',"70%");
	...
	$marco_busqueda->abrir_marco();
		...
		$control->set_propiedades('onclick="guardar4();"');
		$c1 = clone $control;
	    $control->set_propiedades('onclick="guardar6();"');
		$c2 = clone $control;
		$control->set_propiedades('onclick="imprimir();"');
		$c3 = clone $control;
		$control->set_propiedades('onclick="guardar5();"');
		$c4 = clone $control;
		$control->set_propiedades('onclick="guardar7();"');
		$c5 = clone $control;
		$c5->set_name("buscar3");
