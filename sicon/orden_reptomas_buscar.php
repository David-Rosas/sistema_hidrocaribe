...
$cuerpo->abrir_head();
	...
	$cuerpo->add_script($dir_javascript."orden_reptomas_buscar.js");
$cuerpo->cerrar_head();
...
$cuerpo->abrir_body('align="center"',' action="actividad_buscar.php" method="get" name="form"',"90%");
	...
	$marco->abrir_marco();
		...
		$tabla = new grid($connection,"id,fecha,punto,hora,presion,caudal","tomas",array("id","fecha","punto","hora","presion","caudal"),array($listo,$editar,$imprimir),"(id ilike '%$datos%' or fecha ilike '%$datos%' or punto ilike '%$datos%' or hora ilike '%$datos%' or presion ilike '%$datos%' or caudal ilike '%$datos%')","fecha desc,hora desc limit 20");
