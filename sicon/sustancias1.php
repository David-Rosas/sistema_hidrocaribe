...
if(isset($_GET['id']))
{
	...
	$sql = "SELECT hora from sustancias WHERE id='$id'";
	$hora = resultadoIndividual($connection,$sql);
	$sql = "SELECT sitio from sustancias WHERE id='$id'";
	$sitio = resultadoIndividual($connection,$sql);
	$sql = "SELECT tsustancias from sustancias WHERE id='$id'";
	$tsustancias = resultadoIndividual($connection,$sql);
	$sql = "SELECT cantidad from sustancias WHERE id='$id'";
	$cantidad = resultadoIndividual($connection,$sql);
	$sql = "SELECT nguia from sustancias WHERE id='$id'";
	$nguia = resultadoIndividual($connection,$sql);
	$sql = "SELECT recibido from sustancias WHERE id='$id'";
	$recibido = resultadoIndividual($connection,$sql);
	$sql = "SELECT observacion from sustancias WHERE id='$id'";
	$observacion = resultadoIndividual($connection,$sql);
	$sql = "SELECT empresa from sustancias WHERE id='$id'";
	$empresa = resultadoIndividual($connection,$sql);
	$sql = "SELECT autorizado from sustancias WHERE id='$id'";
	$autorizado = resultadoIndividual($connection,$sql);
	$sql = "SELECT fecha2 from sustancias WHERE id='$id'";
	$fecha2 = resultadoIndividual($connection,$sql);
	$sql = "SELECT hora2 from sustancias WHERE id='$id'";
	$hora2 = resultadoIndividual($connection,$sql);
	$sql = "SELECT tsitio from sustancias WHERE id='$id'";
	$tsitio = resultadoIndividual($connection,$sql);
	$sql = "SELECT cantidadt from sustancias WHERE id='$id'";
	$cantidadt = resultadoIndividual($connection,$sql);
	$sql = "SELECT novedad from sustancias WHERE id='$id'";
	$novedad = resultadoIndividual($connection,$sql);
}
else
{
