...
$cuerpo->set_titulo("SICOCON - ORDENES DE TRABAJO CON LISTADO DE SUSPENSIONES PERIODO ".$fecha_ini." al ".$fecha_fin);
$cuerpo->set_languaje();
...
$cuerpo->abrir_body('align="center"',' action="actividad_buscar.php" method="get" name="form"',"90%");
	...
	$marco->set_titulo("");
		...
		$tabla = new grid($connection,"id,fecha,fecha_fin,operadora,actividad,descripcion,zonas,rutas,listado","ordenes_suspension",array("Id","Decha","Ejecución","Operadora","Actividad","Descripcion","Zonas","Rutas","Listado"),array($imprimir),"(fecha>='".$fecha_ini."' and fecha<='".$fecha_fin."')","fecha desc limit 20");
