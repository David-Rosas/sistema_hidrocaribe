...
$cuerpo->abrir_head();
	...
	$marco->abrir_marco();
		...
		$imprimir1 = new boton($dir_png."imprimir.png","imprimir2",$title="Imprimir");
						
		$tabla = new grid($connection,"id,fecha,hora,sitio,causa,causa2,observacion,fechaa,horaa,atendido","estacioness",array("Codigo","Fecha","Hora","Planta","Causa","Categoria","Observación","Fecha A","Hora Arranque","Atendido"),array($editar,$imprimir1),"(sitio='".$sitio."')","sitio desc limit 20");
