...
$cuerpo->abrir_head();
	...
	$marco->abrir_marco();
		...
		$tabla = new grid($connection,"id,fecha,hora,sitio,causa,causa2,observacion,fechaa,horaa,atendido","estacioness",array("Codigo","Fecha","Hora","Planta","Causa","Categoria","Observación","Fecha A","Hora Arranque","Atendido"),array($imprimir1),"(fechaa ='".$fechaa."')","fechaa desc limit 20");
