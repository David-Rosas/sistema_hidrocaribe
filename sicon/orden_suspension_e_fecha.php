...
if(isset($_GET['id']))
{
	$id = $_GET['id'];
	$max_id = $id - 1;
	$sql = "SELECT nombre from operadora WHERE id='$id'";
...
$cuerpo->set_titulo("SICOCON - ORDENES DE TRABAJO EMITIDAS PARA SUSPENSIÓN");
$cuerpo->set_languaje();
...
$cuerpo->abrir_head();
	...
	$cuerpo->add_script($dir_javascript."orden_suspension_e_fecha.js");
