...
$cuerpo->abrir_head();
	...
	$marco->abrir_marco();
		...
		$tabla = new grid($connection,"id,fecha,sitio,hora,nvueltas,tvuelta1,horar2,nvueltas2,tvuelta2,horar3,nvueltas3,tvuelta3","maniobras",array("Codigo","Nombre","Sitio","Hora","N.Vueltas","","Hora","N.Vueltas","","Hora","N.Vueltas","",),array($editar,$imprimir1),"(sitio='".$sitio."')","fecha desc limit 20");
