<?php
		...
		{
			$sql = "SELECT id,fecha,hora,sitio,tsustancias,cantidad,nguia,recibido,observacion,empresa,autorizado,fecha2,hora2,tsitio,cantidadt,novedad FROM sustancias WHERE sitio = '$id' and eliminado=0";	
		}
