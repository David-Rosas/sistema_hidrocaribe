<?php
		...
		{
			$sql = "SELECT id,fecha,hora,sitio,tsustancias,cantidad,nguia,recibido,observacion,empresa,autorizado,fecha2,hora2,tsitio,cantidadt,novedad FROM sustancias WHERE fecha >= '$id' and fecha <='$id1' and eliminado=0";	
		}
	  $resultado = pg_exec($connection, $sql); 
      $pdf =& new Cezpdf('A3','landscape');
      $pdf->selectFont('clases/ezpdf/fonts/Helvetica-Bold.afm');
