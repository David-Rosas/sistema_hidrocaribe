...
$cuerpo->set_titulo("SICON - BUSQUEDA DE PLANTAS/EST. DE AGUA SERVIDAS");
$cuerpo->set_languaje();
...
$cuerpo->abrir_head();
	...
	$cuerpo->add_script($dir_javascript."plantas.js");
$cuerpo->cerrar_head();

$cuerpo->abrir_body('align="center"',' action="plantas_buscar.php" method="get" name="form"',"70%");
	$cuerpo->esp_parrafo();
	...
	$marco->abrir_marco();
		...
		$tabla = new grid($connection,"id,nombre","plantas",array("Codigo","Nombre"),array($editar,$eliminar),"nombre ilike '%$nombre%' and eliminado=0","nombre");
