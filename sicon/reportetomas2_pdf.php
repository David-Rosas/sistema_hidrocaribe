<?php
		...
		{
			$sql = "SELECT id,fecha,punto,hora,presion,caudal FROM tomas WHERE fecha >= '$id' and fecha <='$id1' and eliminado=0";	
		}
	  ...
	  $titulo = array(array("Fecha","Punto","Hora","Presion","Caudal"));
