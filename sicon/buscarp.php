...
$cuerpo->set_titulo("SICON - PUNTOS DE MEDICIÓN");
$cuerpo->set_languaje();
...
$cuerpo->abrir_head();
	...
	$cuerpo->abrir_body('',' action="index1.php" method="post" name="form"',"80%");
	$cuerpo->esp_parrafo();
	...
	$marco->abrir_marco();
		...
		$tabla = new grid($connection,"id,fecha,punto,hora,presion,hora1,presion1,hora2,presion2","puntom",array("Codigo","Fecha","Punto","Hora","Presion","Hora1","Presion1","Hora2","Presion2"),array($editar,$imprimir1,),"(fecha>='".$fecha_ini."' and fecha<='".$fecha_fin."')","fecha desc limit 100");
