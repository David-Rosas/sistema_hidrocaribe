...
<input type="submit" value="Guardar" onClick="this.form.action='areportecdmorochos.php'">
<input type="submit" value="Modificar" onClick="this.form.action='mreportecdmorochos.php'">
<input type="submit" value="Buscar" onClick="this.form.action='breportecdmorochos.php'">
</form>
