...
<input type="submit" value="Guardar" onClick="this.form.action='adiario5.php'">
<input type="submit" value="Modificar" onClick="this.form.action='mdiario5.php'">
<input type="submit" value="Buscar" onClick="this.form.action='buscard5.php'">
</form>
