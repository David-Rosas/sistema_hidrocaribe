<?php
  ...
  // $fecha_fin = $_POST["fecha_fin"];
   echo "$fecha";
	...
	$sql = "SELECT * from tomas where fecha>='$fecha' and fecha<='$fecha'";
	...
	$dataSet->addPoint(new Point("Valor1", $pais[hora]));
	$dataSet->addPoint(new Point("Valor2", $pais[presion]));
	$dataSet->addPoint(new Point("valor3", $pais[caudal]));
