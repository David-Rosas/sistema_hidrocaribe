...
$cuerpo->set_titulo("SICON - BUSQUEDA CATEGORIA DE CAUSAS");
$cuerpo->set_languaje();
...
$cuerpo->abrir_body('align="center"',' action="catcausa_buscar.php" method="get" name="form"',"60%");
	$cuerpo->esp_parrafo();
	...
	//	$eliminar = new boton($dir_gif."eliminar.gif","eliminar",$title="Eliminar");		
		...
		$tabla = new grid($connection,"id,nombre,nombre2","causa2",array("Codigo","Categoria","Causa"),array(),"nombre ilike '%$nombre%' and eliminado=0","nombre");
