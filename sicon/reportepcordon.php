...
<input type="submit" value="Guardar" onClick="this.form.action='areportepcordon.php'">
<input type="submit" value="Modificar" onClick="this.form.action='mreportepcordon.php'">
<input type="submit" value="Buscar" onClick="this.form.action='breportepcordon.php'">
</form>
