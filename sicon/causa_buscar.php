...
$cuerpo->set_titulo("SICON - BUSQUEDA DE CAUSAS");
$cuerpo->set_languaje();
...
$cuerpo->abrir_body('align="center"',' action="causa_buscar.php" method="get" name="form"',"60%");
	$cuerpo->esp_parrafo();
	...
	$marco->abrir_marco();
		...
		$tabla = new grid($connection,"id,nombre","causa",array("Codigo","Nombre"),array($editar,$eliminar),"nombre ilike '%$nombre%' and eliminado=0","nombre");
