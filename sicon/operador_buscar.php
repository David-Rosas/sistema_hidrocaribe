...
$cuerpo->set_titulo("SICON - BUSQUEDA DE OPERADOR");
$cuerpo->set_languaje();
...
$cuerpo->abrir_head();
	...
	$cuerpo->add_script($dir_javascript."operador.js");
$cuerpo->cerrar_head();

$cuerpo->abrir_body('align="center"',' action="operador_buscar.php" method="get" name="form"',"70%");
	$cuerpo->esp_parrafo();
