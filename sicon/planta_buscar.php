...
$cuerpo->set_titulo("SICON - BUSQUEDA DE PLANTAS/EST. DE AGUA POTABLE");
$cuerpo->set_languaje();
...
$cuerpo->abrir_head();
	...
	$cuerpo->add_script($dir_javascript."planta.js");
$cuerpo->cerrar_head();

$cuerpo->abrir_body('align="center"',' action="planta_buscar.php" method="get" name="form"',"70%");
	$cuerpo->esp_parrafo();
	...
	$marco->abrir_marco();
		...
		$tabla = new grid($connection,"id,nombre","planta",array("Codigo","Nombre"),array($editar,$eliminar),"nombre ilike '%$nombre%' and eliminado=0","nombre");
