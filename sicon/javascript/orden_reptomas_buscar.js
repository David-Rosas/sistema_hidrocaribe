...
{
	location.href="orden_suspension.php?id="+id+"&ale="+aleatorio(0,999999);
}
function imprimir(id,remitente)
{
	location.href="impresiontomas_pdf.php?id="+id+"&ale="+aleatorio(0,999999);
}
function find()
{
	
	location.href="orden_reptomas_buscar.php?datos="+document.form.datos.value+'&ale='+aleatorio(0,999999);
}
function recargar()
{
