...
{
	location.href="orden_notificacion.php?id="+id+"&ale="+aleatorio(0,999999);
}
function imprimir(id,remitente)
{
	location.href="orden_notificacion_pdf.php?id="+id+"&ale="+aleatorio(0,999999);
}
function find()
{
	location.href="orden_notificacion_buscar.php?datos="+document.form.datos.value+'&ale='+aleatorio(0,999999);
}
function recargar()
{
