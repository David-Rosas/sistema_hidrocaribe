...
function graficar()
{
     if(vacio(document.form.sitio.value,"Sitio"))
		location.href="grafica.php?sitio="+document.form.sitio.value+'&ale='+aleatorio(0,999999);
}
	 
function graficar2()
{
if(vacio(document.form.sitio.value,"Sitio") && vacio(document.form.causa.value,"Causa")&& vacio(document.form.fecha_ini.value,"Fecha Inicial")&&vacio(document.form.fecha_fin.value,"Fecha Final"))
		location.href="grafica.php?sitio="+document.form.sitio.value+"&causa="+document.form.causa.value+"&fecha_ini="+document.form.fecha_ini.value+"&fecha_fin="+document.form.fecha_fin.value+'&ale='+aleatorio(0,999999);
}
...
{
	if(vacio(document.form.fecha_ini.value,"Fecha Inicial") && vacio(document.form.fecha_fin.value,"Fecha Final"))
		location.href="buscare2.php?fecha_ini="+document.form.fecha_ini.value+"&fecha_fin="+document.form.fecha_fin.value+'&ale='+aleatorio(0,999999);
	
}
function guardar5()
{
	if(vacio(document.form.causa.value,"Causa"))
		location.href="buscarec2.php?causa="+document.form.causa.value+'&ale='+aleatorio(0,999999);
	
}
function guardar6()
{
	if(vacio(document.form.sitio.value,"P/T y E/B"))
		location.href="buscarep2.php?sitio="+document.form.sitio.value+'&ale='+aleatorio(0,999999);
	
}
function guardar7()
{
	if(vacio(document.form.fechaa.value,"Fecha Arranque"))
		location.href="buscarefa2.php?fechaa="+document.form.fechaa.value+'&ale='+aleatorio(0,999999);
