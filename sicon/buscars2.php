...
$cuerpo->abrir_head();
	...
	$marco->abrir_marco();
	   ...
	   // $editar = new boton($dir_png."editar.png","editar",$title="Editar"); 
		...
		$tabla = new grid($connection,"id,fecha,hora,sitio,tsustancias,cantidad,nguia,recibido,empresa,fecha2,hora2,tsitio,cantidadt,novedad","sustancias",array("Codigo","Fecha","Hora","Planta","Sustancias","Cantidad","N.Guia","Recibido","Empresa","Fecha","Hora","Planta Tranf.","Hora","Novedad"),array($imprimir1),"(fecha>='".$fecha_ini."' and fecha<='".$fecha_fin."')","fecha desc limit 20");
