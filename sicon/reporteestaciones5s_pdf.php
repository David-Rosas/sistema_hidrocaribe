<?php
		...
		$id = $_GET['fechaa'];
		if (!isset($id) || $id==""){
			$sql = "SELECT * FROM estacioness";
		}
		else
		{
			$sql = "SELECT id,fecha,hora,sitio,causa,observacion,fechaa,horaa,atendido FROM estacioness WHERE fechaa = '$id' and eliminado=0";	
		}
	  ...
	  $titulo = array(array("Fecha","Hora","Sitio","Causa","Observacion","Fecha A","Hora A","Atendido por"));
