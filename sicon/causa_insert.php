...
$max_id = $max_id + 1; 
if(resultadoIndividual($connection,"SELECT nombre FROM causa WHERE id='$id'") == "")
{
	$sql = "INSERT INTO causa (id,nombre,eliminado) values ('$max_id','$nombre',0)";
	$msg = "Guardados";
}
else
{
	$sql = "UPDATE causa set nombre='$nombre' WHERE id='$id'";
	$msg = "Actualizados";
}
