...
$cuerpo->abrir_head();
	...
	$marco->abrir_marco();
		...
		$imprimir1 = new boton($dir_png."imprimir.png","imprimir3",$title="Imprimir");
						
		$tabla = new grid($connection,"id,fecha,hora,sitio,causa,causa2,observacion,fechaa,horaa,atendido","estacioness",array("Codigo","Fecha","Hora","Planta","Causa","Categoria","Observación","Fecha A","Hora Arranque","Atendido"),array($editar,$imprimir1),"(causa='".$causa."')","causa desc limit 20");
