...
if(isset($_GET['id']))
{
	$id = $_GET['id'];
	$max_id = $id - 1;
	$sql = "SELECT nombre from operador WHERE id='$id'";
...
$cuerpo->set_titulo("SICOCON - OPERADORES");
$cuerpo->set_languaje();
...
$cuerpo->abrir_body('',' action="index1.php" method="post" name="form"',"60%");
	...
	$marco->abrir_marco();
		...
		$marco->generar_botones(array($c,$c1,$c3,$c2)); //genera varios controles en posicion horizontal a diferencia de addcontrol
