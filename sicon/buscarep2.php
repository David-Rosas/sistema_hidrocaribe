...
$cuerpo->abrir_head();
	...
	//	$editar = new boton($dir_png."editar.png","editar",$title="Editar");
		...
		$tabla = new grid($connection,"id,fecha,hora,sitio,causa,causa2,observacion,fechaa,horaa,atendido","estaciones",array("Codigo","Fecha","Hora","Planta","Causa","Categoria","Observación","Fecha A","Hora Arranque","Atendido"),array($imprimir1),"(sitio='".$sitio."')","sitio desc limit 20");
