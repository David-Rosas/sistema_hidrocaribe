...
$cuerpo->set_titulo("SICON - BUSQUEDA DE CATEGORIA VALVULA");
$cuerpo->set_languaje();
...
$cuerpo->abrir_head();
	...
	$cuerpo->add_script($dir_javascript."catvalvula.js");
$cuerpo->cerrar_head();

$cuerpo->abrir_body('align="center"',' action="catvalvula_buscar.php" method="get" name="form"',"60%");
	$cuerpo->esp_parrafo();
	...
	$marco->abrir_marco();
		...
		$tabla = new grid($connection,"id,nombre,nombre2","catvalvula",array("Codigo","Categoria","Valvula"),array(),"nombre ilike '%$nombre%' and eliminado=0","nombre");
