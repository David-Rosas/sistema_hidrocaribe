...
$cuerpo->abrir_head();
	...
	$marco->abrir_marco();
		...
		$tabla = new grid($connection,"id,fecha,hora,sitio,tsustancias,cantidad,nguia,recibido,empresa,fecha2,hora2,tsitio,cantidadt,novedad","sustancias",array("Codigo","Fecha","Hora","Planta","Sustancias","Cantidad","N.Guia","Recibido","Empresa","Fecha","Hora","Planta Tranf.","Hora","Novedad"),array($imprimir3),"(tsustancias='".$tsustancias."')","tsustancias desc limit 20");
