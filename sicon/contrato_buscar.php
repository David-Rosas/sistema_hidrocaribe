...
$cuerpo->set_titulo("SICOCON - BUSQUEDA DE TIPOS DE CONTRATOS");
$cuerpo->set_languaje();
...
$cuerpo->abrir_head();
	...
	$cuerpo->add_script($dir_javascript."contrato.js");
$cuerpo->cerrar_head();

$cuerpo->abrir_body('align="center"',' action="contrato_buscar.php" method="get" name="form"',"70%");
	$cuerpo->esp_parrafo();
	...
	$marco->abrir_marco();
		...
		$tabla = new grid($connection,"id,nombre","contrato",array("Codigo","Nombre"),array($editar,$eliminar),"nombre ilike '%$nombre%' and eliminado=0","nombre");
