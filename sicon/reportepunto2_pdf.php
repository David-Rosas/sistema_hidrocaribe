<?php
		...
		$id1 = $_GET['fecha_fin'];
		if (!isset($id) || $id==""){
			$sql = "SELECT * FROM puntom";
		}
		else
		{
			$sql = "SELECT id,fecha,punto,hora,presion,hora1,presion1,hora2,presion2 FROM puntom WHERE fecha >= '$id' and fecha <='$id1' and eliminado=0";	
		}
	  ...
	  $pdf->ezText("<b>Reportes de Tomas</b>\n",14,array('justification'=>'center'));	
	  $titulo = array(array("Fecha","Punto","Hora","Presion","Hora1","Presion1","Hora2","Presion2"));
