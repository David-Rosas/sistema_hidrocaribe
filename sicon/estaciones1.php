...
if(isset($_GET['id']))
{
	...
	$sql = "SELECT hora from estaciones WHERE id='$id'";
	$hora = resultadoIndividual($connection,$sql);
	$sql = "SELECT sitio from estaciones WHERE id='$id'";
	$sitio = resultadoIndividual($connection,$sql);
	$sql = "SELECT causa from estaciones WHERE id='$id'";
	$idc = resultadoIndividual($connection,$sql);
	$sql = "SELECT causa2 from estaciones WHERE id='$id'";
	$idc2 = resultadoIndividual($connection,$sql);
	$sql = "SELECT observacion from estaciones WHERE id='$id'";
	$observacion = resultadoIndividual($connection,$sql);
	$sql = "SELECT fechaa from estaciones WHERE id='$id'";
	$fechaa = resultadoIndividual($connection,$sql);
	$sql = "SELECT horaa from estaciones WHERE id='$id'";
	$horaa = resultadoIndividual($connection,$sql);
	$sql = "SELECT atendido from estaciones WHERE id='$id'";
