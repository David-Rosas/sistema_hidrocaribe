...
<input type="submit" value="Guardar" onClick="this.form.action='areportepturimiquire.php'">
<input type="submit" value="Modificar" onClick="this.form.action='mreportepturimiquire.php'">
<input type="submit" value="Buscar" onClick="this.form.action='breportepturimiquire.php'">
</form>
