...
<input type="submit" value="Guardar" onClick="this.form.action='adiario3.php'">
<input type="submit" value="Modificar" onClick="this.form.action='mdiario3.php'">
<input type="submit" value="Buscar" onClick="this.form.action='buscard3.php'">
</form>
