...
$cuerpo->abrir_head();
	...
	$marco->abrir_marco();
		...
		$tabla = new grid($connection,"id,fecha,punto,hora,hora,presion,hora1,presion1,hora2,presion2","puntom",array("Codigo","Fecha","Punto","Hora","Presion","Hora1","Presion1","Hora2","Presion2"),array($imprimir2,),"(punto='".$punto."')","punto desc limit 100");
