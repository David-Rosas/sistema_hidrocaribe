...
<input type="submit" value="Guardar" onClick="this.form.action='areportepmcordon.php'">
<input type="submit" value="Modificar" onClick="this.form.action='mreportepmcordon.php'">
<input type="submit" value="Buscar" onClick="this.form.action='breportepmcordon.php'">
</form>
