...
$cuerpo->set_titulo("SICOCON - BUSQUEDA DE TIPO DE SUSTANCIAS");
$cuerpo->set_languaje();
...
$cuerpo->abrir_head();
	...
	$cuerpo->add_script($dir_javascript."tsustancia.js");
$cuerpo->cerrar_head();

$cuerpo->abrir_body('align="center"',' action="tsustancia_buscar.php" method="get" name="form"',"70%");
	$cuerpo->esp_parrafo();
	$marco->set_class_titulo('tituloDOSE_4');
	$marco->set_colspan(3);
	$marco->set_propiedades('class="formato-blanco" align="center" border="0" cellpadding="0" cellspacing="0" width="80%"');
	...
	$marco->abrir_marco();
		...
		$eliminar = new boton($dir_gif."eliminar.gif","eliminar",$title="Eliminar Tipo de Orden de Trabajo");		
		
		$tabla = new grid($connection,"id,nombre","tsustancias",array("Codigo","Nombre"),array($editar,$eliminar),"nombre ilike '%$nombre%' and eliminado=0","nombre");
